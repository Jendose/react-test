...
class TrackListElement extends React.Component {
    ...
    updateLike = (booleanValue) => {
        this.setState({isLiked:booleanValue});
    }
                ...
                <div className={this.state.status === "ONSALE"?"card":"card--red"}>
                    ...
                    <div className="card__info">
                        <div className="info__title">
                            {this.props.name!=null?<NavLink to={'/tracks/'+this.props.id} className="title-element">{this.props.name}</NavLink>:<div className="text-block"> —</div>}
                        ...
                        <div className="info__body">
                            <div className="info__listen">
                                ...
                                {this.props.duration!=null?<div className="text-block--time">{this.toHMS(this.props.duration)}</div>:<div className="text-block"> —</div>}
                            </div>
